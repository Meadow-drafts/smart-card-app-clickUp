...
function CTA ()  {
  return (
    <section className={`flex justify-center items-center sm:my-16 my-6sm:px-16 px-6 sm:py-12 py-4 sm:flex-row flex-col bg-gradient-to-r from-fuchsia-500 rounded-[20px] box-shadow`}>
