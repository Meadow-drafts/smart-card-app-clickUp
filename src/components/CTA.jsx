...
function CTA ()  {
  return (
    <section id='cta' className={`flex justify-center shadow-lg items-center sm:my-16 my-6 sm:px-16 px-6 sm:py-12 py-4 sm:flex-row flex-col bg-gradient-to-r from-gray-300 rounded-[20px] box-shadow`}>
